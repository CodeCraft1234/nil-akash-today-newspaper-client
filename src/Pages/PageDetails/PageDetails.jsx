...
const PageDetails = () => {
  ...
  return (
    ...
    <Helmet>
          <title>{`Page - ${datas.title}`}</title>
          <meta name="description" content={datas.title} />
          <meta
            name="keywords"
            content={`zookachu, zookachu profile, ${datas.title}, ${
                datas?.title
            }, ${
                datas.title || "zookachu viral"
          ...
          <meta property="og:title" content={`Profile - ${datas?.title}`} />
          <meta
            property="og:description"
            content={datas?.description || "Check out this profile on Zookachu!"}
          />
          <meta property="og:type" content="profile" />
          <meta
            property="og:url"
            content={`https://nilakashtoday.com/newsDetails/${datas?._id}`}
          />
          <meta
            property="og:image"
            content={datas?.photo || "/avatar-placeholder.png"}
          /> 
          <meta property="og:site_name" content="NilAkash Today" />
          <meta
            property="profile:first_name"
            content={datas?.title?.split(" ")[0]}
          />
          <meta
            property="profile:last_name"
            content={datas?.title?.split(" ")[1] || ""}
          />
          <meta property="profile:username" content={datas?.title} />
