...
const AllProduct = () => {
  ...
  <div className="mb-4 flex justify-center lg:justify-between items-center flex-wrap  gap-0 ">
      <div className="grid grid-cols-3 sm:grid-cols-3 lg:grid-cols-8 gap-2">
      <button
    ...
    <button
      ...
      onClick={() => handleTabClick("islamicBook")}
    >
      Islamic
    </button>
    <button
      ...
      onClick={() => handleTabClick("allBook")}
    >
     Books
    </button>
    <button
    ...
    <button
      className={`py-2 mb-2 px-4 rounded-full hover:bg-[#FF7701] focus:outline-none ${activeTab === "nailcare" ? 'bg-blue-500 text-white' : 'bg-green-600 text-white'}`}
      onClick={() => handleTabClick("electronic")}
    >
      Electronic
    </button>
      </div>
