    ...
    <div className="text-black mx-4">
      <div className="grid grid-cols-1 border-t-2 border-black p-2 gap-4 lg:grid-cols-4 lg:gap-5">
          ...
          <div className="w-full  overflow-hidden  my-4">
            ...
            <div className="px-6 py-4">
              ...
              <p className="text-black text-sm md:text-base">
                চট্টগ্রামের আনোয়ারা উপজেলায় বাজেটকে স্বাগত জানিয়ে আনন্দ মিছিলের
                আগে অর্থ প্রতিমন্ত্রী ওয়াসিকা আয়শা খান ও সাবেক ভূমিমন্ত্রী
                সাইফুজ্জামান চৌধুরীর অনুসারীদের দু’গ্রুপের সংঘর্ষের ঘটনা ঘটেছে
              </p>
            </div>
        ...
        <div className=" border-l-2 border-black p-2 ">
          <h1 className="text-3xl font-bold ">আন্তর্জাতিক</h1>
          <div className="w-full  overflow-hidden  my-4">
            <img
              className="w-full h-auto object-cover transform transition-transform duration-500 hover:scale-105"
              src="https://i.ibb.co/kgYtcF7/kajol.jpg"
