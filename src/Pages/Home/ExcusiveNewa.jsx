    ...
    return (
        <div>
            <section className="px-5 py-10 ">
                <div className="container grid text-black  grid-cols-12 mx-auto gap-y-6 md:gap-10">
                    <div className="flex flex-col justify-between col-span-12 py-2 space-y-8 md:space-y-16 md:col-span-3">
                        ...
                        <div className="flex flex-col w-full space-y-2">
                            ...
                            <a rel="noopener noreferrer" href="#" className="flex items-center justify-between w-full">
                                ...
                                <svg viewBox="0 0 24 24" strokeWidth="2.5" fill="none" strokeLinecap="round" strokeLinejoin="round" className="w-4 stroke-current dark:text-violet-400">
